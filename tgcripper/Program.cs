					...
					while ((line = sr.ReadLine()) != null)
					{
						...
						foreach (IWebElement element in elements)
						{
							if (element.GetAttribute("data-film-id") != null)
							{
								...
								string args = "-s16 -j16 -x16 --file-allocation=none --console-log-level=error -o \"" + Path.DirectorySeparatorChar + course_name + Path.DirectorySeparatorChar + pos_start.ToString() + " - " + title + ".mp4\" " + download_video_url;
